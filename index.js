...
// ---- DB ----
const db = new Database("./brainrot_mm.sqlite");
...
function helpMainEmbed() {
  return new EmbedBuilder()
    ...
    .setImage("https://cdn.discordapp.com/attachments/1465219619265581150/1469774737067610404/channels4_banner.jpg?ex=6988e1e4&is=69879064&hm=d50888b0a14605655fdc05d7969aaa014c363df2a224ee178c501913356c1b64&")     // BIG banner image
    .setThumbnail("https://cdn.discordapp.com/attachments/1465219619265581150/1469763914895065341/channels4_profile.jpg?ex=6988d7d0&is=69878650&hm=7d96542aedb64283c04825c3279930653a64a9dec9493ec453aca00ea2629717&")  // Small logo (top-right)
...
function mmPanelEmbed() {
  return new EmbedBuilder()
    .setColor(0x5b2cff)
    .setTitle("🔒 Zenix's — Middleman Service")
    .setDescription(
    ...
    // 🔹 BIG IMAGE (banner)
    .setImage("https://cdn.discordapp.com/attachments/1465219619265581150/1469774737067610404/channels4_banner.jpg?ex=6988e1e4&is=69879064&hm=d50888b0a14605655fdc05d7969aaa014c363df2a224ee178c501913356c1b64&")

    // 🔹 SMALL IMAGE (thumbnail / logo)
    .setThumbnail("https://cdn.discordapp.com/attachments/1465219619265581150/1469763914895065341/channels4_profile.jpg?ex=6988d7d0&is=69878650&hm=7d96542aedb64283c04825c3279930653a64a9dec9493ec453aca00ea2629717&")
...
function ticketEmbed(data, guild) {
  ...
  return new EmbedBuilder()
    .setTitle("📨 Zenix's Middleman Ticket")
    ...
    .setThumbnail("https://cdn.discordapp.com/attachments/1465219619265581150/1469774737067610404/channels4_banner.jpg?ex=6988e1e4&is=69879064&hm=d50888b0a14605655fdc05d7969aaa014c363df2a224ee178c501913356c1b64&")
    .setImage("https://cdn.discordapp.com/attachments/1465219619265581150/1469763914895065341/channels4_profile.jpg?ex=6988d7d0&is=69878650&hm=7d96542aedb64283c04825c3279930653a64a9dec9493ec453aca00ea2629717&")
...
function buildTicketModal(tierKey) {
  ...
  const modal = new ModalBuilder()
    ...
    .setTitle("Brainrot MM Request Form");
